...
results_path = r"C:\Users\Davide Mascheroni\Desktop\movingText\movingText\Programs\Machine_Learning\Machine_Learning_results\Verification_single_intruders_results\Verification_single_intruders_results_ft.csv"
#results_path = r"C:\Users\david\OneDrive\Documenti\Tesi_BehavBio\Programs\Programs\Machine_Learning\Machine_Learning_results\Verification_single_intruders_results\Verification_single_intruders_results_ft.csv"
...
roc_save_path =  r"C:\Users\Davide Mascheroni\Desktop\movingText\movingText\Programs\Machine_Learning\Machine_Learning_results\Verification_single_intruders_results\best_animation_roc_curves_ft.png"
#roc_save_path = r"C:\Users\david\OneDrive\Documenti\Tesi_BehavBio\Programs\Programs\Machine_Learning\Machine_Learning_results\Verification_single_intruders_results\best_animation_roc_curves_ft.png"
...
def prepare_open_set_train_data(dataset, person_data, train_ids, test_ids, seed, features_cols):
...
def train_and_evaluate_open_set(dataset, animation, clf_name, clf_pipeline, features_cols, best_params, train_ids, test_ids, num_seed, results_path):
    ...
    for person in dataset['tester_id'].unique():
        ...
        # Train multiple times to sample different impostors
        for seed in range(num_seed):
            X_train, y_train, X_test, y_test = prepare_open_set_train_data(
                dataset, person_data_all, train_ids, test_ids, seed, features_cols
            )
