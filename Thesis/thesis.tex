...
\begin{itemize}
    \item \(f_{11n}\) — \textbf{Minimum distance}: Smallest shift between consecutive fixations, indicating very local gaze changes.
    \item \(f_{12n}\) — \textbf{Maximum distance}: Largest shift, reflecting broad scanning movements.
    \item \(f_{13n}\) — \textbf{Arithmetic mean distance}: Average spatial shift, representing typical scanning magnitude.
    \item \(f_{14n}\) — \textbf{Geometric mean distance}: Central tendency less influenced by extreme distances.
    \item \(f_{15n}\) — \textbf{Median distance}: Middle value of fixation-to-fixation distances.
    \item \(f_{16n}\) — \textbf{Standard deviation distance}: Variability of spatial shifts.
    \item \(f_{17n}\) — \textbf{Median absolute deviation distance}: Robust measure of spatial variability.
    \item \(f_{18n}\) — \textbf{Skewness distance}: Asymmetry of the distance distribution.
    \item \(f_{19n}\) — \textbf{Interquartile range distance}: Dispersion measure excluding extreme values.
    \item \(f_{20n}\) — \textbf{Kurtosis distance}: Shape of the spatial distance distribution.
\end{itemize}
...
\begin{itemize}
    \item \(f_{21n}\) — Minimum saccade speed: The lowest velocity observed among saccades, indicating the slowest gaze transitions.
    \item \(f_{22n}\) — Maximum saccade speed: The highest velocity recorded, reflecting the most abrupt shifts in gaze.
    \item \(f_{23n}\) — Arithmetic mean saccade speed: Average speed across all saccades within the trial.
    \item \(f_{24n}\) — Geometric mean saccade speed: Central tendency of saccade speeds, less influenced by extreme values.
    \item \(f_{25n}\) — Median saccade speed: The middle speed value, robust against outlier influence.
    \item \(f_{26n}\) — Standard deviation saccade speed: Variability of saccadic velocities across the trial.
    \item \(f_{27n}\) — Median absolute deviation saccade speed: Robust measure of variation in saccade dynamics.
    \item \(f_{28n}\) — Skewness saccade speed: Asymmetry of the saccade speed distribution, indicating bias toward slower or faster movements.
    \item \(f_{29n}\) — Interquartile range saccade speed: Spread of saccade velocities within the 25th–75th percentile range.
    \item \(f_{30n}\) — Kurtosis saccade speed: Peakedness or tail heaviness of the speed distribution.
\end{itemize}
...
\begin{itemize}
    \item \(f_{31n}\) — Scanpath length: Total cumulative distance of gaze movements during a trial, representing the overall extent of visual exploration.
\end{itemize}
...
\begin{itemize}
    \item \(f_{32n}, f_{42n}\) — Minimum pupil diameter
    \item \(f_{33n}, f_{43n}\) — Maximum pupil diameter
    \item \(f_{34n}, f_{44n}\) — Arithmetic mean pupil diameter
    \item \(f_{35n}, f_{45n}\) — Geometric mean pupil diameter
    \item \(f_{36n}, f_{46n}\) — Median pupil diameter
    \item \(f_{37n}, f_{47n}\) — Standard deviation pupil diameter
    \item \(f_{38n}, f_{48n}\) — Median absolute deviation pupil diameter
    \item \(f_{39n}, f_{49n}\) — Skewness pupil diameter
    \item \(f_{40n}, f_{50n}\) — Interquartile range pupil diameter
    \item \(f_{41n}, f_{51n}\) — Kurtosis pupil diameter
\end{itemize}
...
\begin{itemize}
    \item \(f_{52n}\) — Minimum ratio
    \item \(f_{53n}\) — Maximum ratio
    \item \(f_{54n}\) — Arithmetic mean ratio
    \item \(f_{55n}\) — Geometric mean ratio
    \item \(f_{56n}\) — Median ratio
    \item \(f_{57n}\) — Standard deviation ratio
    \item \(f_{58n}\) — Median absolute deviation ratio
    \item \(f_{59n}\) — Skewness ratio
    \item \(f_{60n}\) — Interquartile range ratio
    \item \(f_{61n}\) — Kurtosis ratio
\end{itemize}
...
\begin{itemize}
    \item \(f_{62n}\) — Minimum difference
    \item \(f_{63n}\) — Maximum difference
    \item \(f_{64n}\) — Arithmetic mean difference
    \item \(f_{65n}\) — Median difference
    \item \(f_{66n}\) — Standard deviation difference
    \item \(f_{67n}\) — Median absolute deviation difference
    \item \(f_{68n}\) — Skewness difference
    \item \(f_{69n}\) — Interquartile range difference
    \item \(f_{70n}\) — Kurtosis difference
\end{itemize}
...
\begin{itemize}
    \item \(f_{71n}\) — Number of blinks
    \item \(f_{72n}\) — Mean blink duration
    \item \(f_{73n}\) — Minimum blink duration
    \item \(f_{74n}\) — Maximum blink duration
\end{itemize}
...
\begin{itemize}
    \item \(f_{75n}\) — Total upward distance (\(\Delta y < 0\))
    \item \(f_{76n}\) — Total downward distance (\(\Delta y > 0\))
    \item \(f_{77n}\) — Total leftward distance (\(\Delta x < 0\))
    \item \(f_{78n}\) — Total rightward distance (\(\Delta x > 0\))
    \item \(f_{79n}\) — Number of upward transitions
    \item \(f_{80n}\) — Number of downward transitions
    \item \(f_{81n}\) — Number of leftward transitions
    \item \(f_{82n}\) — Number of rightward transitions
\end{itemize}
...
[115] What is the Difference between Identification, Identity Verification and Authentication?, \url{https://www.pingidentity.com/en/resources/blog/post/identification-vs-verification-vs-authentication.html}
