...
text31 = "Arese is a comune in the Metropolitan City of Milan in the Italian region Lombardy, about 12 kilometres northwest of Milan. Arese borders the following municipalities: Lainate, Garbagnate Milanese, Bollate, Rho, Milan. Arese was awarded the honorary title of city by presidential decree of 25 October 1985. Of particular interest in the historical centre is the Church of St Peter and Paul."
...
text33 = "Cusano Milanino is a town and comune in the Metropolitan City of Milan, in Lombardy. Cusano Milanino is about 13 kilometers far from the centre of Milan. It borders Paderno Dugnano, Cinisello Balsamo, Cormano, and Bresso. The 18th-century Italian economist and antiquarian Count Carli died in the town, then part of the Duchy of Milan, in 1795. Cusano is also the birthplace of former football player and coach Giovanni Trapattoni."
...
text41 = "Carugate is a comune in the Metropolitan City of Milan in the Italian region Lombardy, located about 15 kilometres northeast of Milan. Carugate borders the following municipalities: Agrate Brianza, Caponago, Brugherio, Pessano con Bornago, Bussero, Cernusco sul Naviglio."
...
text45 = "Rescaldina is a comune that is part of the Metropolitan City of Milan, in the Province of Milan in the Italian region Lombardy, with a population of 14,211 distributed over about 8 km2, and located about 25 kilometres northwest of Milan. Rescaldina borders the following municipalities: Cislago, Gorla Minore, Gerenzano, Marnate, Uboldo, Castellanza, Legnano and Cerro Maggiore. Except for Legnano and Cerro Maggiore, the other municipalities belong to the Province of Varese."
text46 = "Busto Garolfo is a comune in the Metropolitan City of Milan of 13 978 inhabitants. Busto Garolfo is located in the Italian region Lombardy, placed about 25 kilometres northwest of Milan. In the local dialect, belonging to Western Lombard, it is called Büst Picul ('Small Busto'), to distinguish it from Büsti Grandi ('Big Busto', which indicates the town of Busto Arsizio) and Büst Cava (or Büscaa, i.e. Buscate)."
text47 = "Opera is a comune (municipality) in the Metropolitan City of Milan in the Italian region Lombardy, located about 10 kilometres (6 mi) southeast of Milan. Opera borders the following municipalities: Locate di Triulzi, Milan, Pieve Emanuele, Rozzano, San Donato Milanese. It is home to the early 13th century Abbey of Mirasole."
...
text50 = "Trezzo sull'Adda is a comune (municipality) in the Metropolitan City of Milan in the Italian region Lombardy, located about 30 kilometres (19 mi) northeast of Milan on the Adda River. The Naviglio Martesana canal starts from the Adda in Trezzo's territory. Trezzo sull'Adda borders the following municipalities: Cornate d'Adda, Bottanuco, Capriate San Gervasio, Busnago, Grezzago, Vaprio d'Adda. Trezzo received the honorary title of city with a presidential decree on 8 July 2008."
...
text53 = "Arluno also known as Manume is a comune (municipality) in the Metropolitan City of Milan in the Italian region Lombardy, located about 20 miles (32 km) west of Milan. Arluno borders the following municipalities: Parabiago, Nerviano, Pogliano Milanese, Casorezzo, Vanzago, Ossona, Sedriano, Santo Stefano Ticino, Vittuone, and Corbetta."
...
text56 = "Pero in the Province of Milan in the Italian region Lombardy, located about 9 kilometres (6 mi) northwest of Milan. As of 31 December 2004, it had a population of 10,378 and an area of 5.0 square kilometres (1.9 sq mi). The municipality of Pero contains the frazioni (subdivisions, mainly villages and hamlets) Cerchiate and Cerchiarello. Pero borders the following municipalities: Rho, Milan. Pero is linked to Milan and Rho by the underground line M1 (a.k.a. 'red line')."
...
text58 = "Locate di Triulzi is a comune (municipality) in the Metropolitan City of Milan in the Italian region Lombardy, located about 14 kilometres (9 mi) southeast of Milan. Locate di Triulzi borders the following municipalities: San Donato Milanese, San Giuliano Milanese, Opera, Pieve Emanuele, Carpiano, Siziano. Sights include the 14th century Trivulzio Castle. It is served by Locate Triulzi railway station."
...
text62 = "Vanzago is a comune (municipality) in the Province of Milan in the Italian region Lombardy, located about 15 kilometres (9 mi) northwest of Milan. As of 31 December 2004, it had a population of 7,615 and an area of 6.2 square kilometres (2.4 sq mi). The municipality of Vanzago contains the frazioni (subdivisions, mainly villages and hamlets) Mantegazza, Valdarenne, and Tre Campane. Vanzago borders the following municipalities: Pogliano Milanese, Pregnana Milanese, Arluno, Sedriano."
text63 = "Gaggiano is a comune (municipality) in the Province of Milan in the Italian region Lombardy, located about 13 kilometres (8 miles) southwest of Milan. As of 31 December 2004, it had a population of 8,360 and an area of 26.7 square kilometres (10.3 sq mi). Gaggiano borders the following municipalities: Cusago, Cisliano, Albairate, Trezzano sul Naviglio, Vermezzo, Zibido San Giacomo, Gudo Visconti, Noviglio, Rosate. Gaggiano is served by Gaggiano railway station."
...
def hor_scroll_slow_little(txt):
  horizontalScroll(txt, LOW_SPEED, LITTLE_CHAR, "SL_LIT")

def hor_scroll_slow_big(txt):
  horizontalScroll(txt, LOW_SPEED, BIG_CHAR, "SL_BIG")

def hor_scroll_fast_little(txt):
  horizontalScroll(txt, HIGH_SPEED, LITTLE_CHAR, "FA_LIT")
