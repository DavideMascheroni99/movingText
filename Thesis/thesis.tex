...
To conclude the analysis Figure \ref{fig:roc_st} illustrates the ROC curves corresponding to each animation, generated using the classifier that achieved the lowest Equal Error Rate (EER).
...
The remaining results for the other animations are presented in Section \ref{subsec:vs_st_ft}, due to space constraints.
...
Table \ref{fig:VB_FA_BIG_5_st} display the best performing animation, while the additional results regarding the other animations are contained in appendix \ref{subsec:vsc_st_ft}.
...
Additional results related to this analysis are provided in the corresponding appendix (Section \ref{subsec:vsci_st_ft}).
...
All the additional material related to this type of analysi are placed in the subsection \ref{subsec:vsc_rt}.
...
These results, due to their extensive length, are available in the online repository at the following link:
...
\begin{figure}[ht]
    ...
    \textwidth]{Images/Results/Verification_single/st/HS_SL_LIT.png}
    \caption{HS\_SL\_LIT animation}
    \label{fig:HS_SL_LIT_sti}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_intruders/st/HS_SL_BIG.png}
    \caption{HS\_SL\_BIG animation}
    \label{fig:HS_SL_BIG_sti}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_intruders/st/VB_SL_BIG.png}
    \caption{VB\_SL\_BIG animation}
    \label{fig:VB_SL_BIG_sti}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_intruders/st/HS_FA_LIT.png}
    \caption{HS\_FA\_LIT animation}
    \label{fig:HS_FA_LIT_sti}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_intruders/st/HS_FA_BIG.png}
    \caption{HS\_FA\_BIG animation}
    \label{fig:HS_FA_BIG_sti}
\end{figure}

\subsection{Verification Single ST with Reduced Session Duration - Animations}
\label{subsec:vs_st_ft}

The following appendix presents the results for all animations under reduced recording durations of 10 seconds and 5 seconds.
The outcomes obtained using the 10-second window are reported first, followed by those corresponding to the 5-second recordings.

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/ten/VB_SL_LIT.png}
    \caption{VB\_SL\_LIT animation - ten}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/ten/HS_SL_LIT.png}
    \caption{HS\_SL\_LIT animation- ten}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/ten/VB_SL_BIG.png}
    \caption{VB\_SL\_BIG animation - ten}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/ten/HS_SL_BIG.png}
    \caption{HS\_SL\_BIG animation - ten}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/ten/VB_FA_LIT.png}
    \caption{VB\_FA\_LIT animation - ten}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/ten/HS_FA_BIG.png}
    \caption{HS\_FA\_BIG animation - ten} 
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/ten/HS_FA_LIT.png}
    \caption{HS\_FA\_LIT animation - ten}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/five/VB_SL_LIT.png}
    \caption{VB\_SL\_LIT animation - five}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/five/HS_SL_LIT.png}
    \caption{HS\_SL\_LIT animation - five}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/five/VB_SL_BIG.png}
    \caption{VB\_SL\_BIG animation - five}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/five/HS_SL_BIG.png}
    \caption{HS\_SL\_BIG animation - five}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/five/VB_FA_LIT.png}
    \caption{VB\_FA\_LIT animation - five}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/five/HS_FA_BIG.png}
    \caption{HS\_FA\_BIG animation - five} 
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single_five_ten/st/five/HS_FA_LIT.png}
    \caption{HS\_FA\_LIT animation - five}
\end{figure}

\subsection{Verification 'classic' Single ST - Animations}
\label{subsec:vsc_st_ft}

The following appendix presents all additional animation results that were omitted from the corresponding chapter due to space limitations.

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_single/st/VB_SL_LIT.png}
    \caption{VB\_SL\_LIT animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_single/st/HS_SL_LIT.png}
    \caption{HS\_SL\_LIT animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_single/st/VB_SL_BIG.png}
    \caption{VB\_SL\_BIG animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_single/st/HS_SL_BIG.png}
    \caption{HS\_SL\_BIG animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_single/st/VB_FA_LIT.png}
    \caption{VB\_FA\_LIT animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_single/st/HS_FA_BIG.png}
    \caption{HS\_FA\_BIG animation} 
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_single/st/HS_FA_LIT.png}
    \caption{HS\_FA\_LIT animation}
\end{figure}
...
This section contain the additional results obtained during the 'classic' verification analysis with intruders.

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_intruders/st/VB_SL_LIT.png}
    \caption{VB\_SL\_LIT animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_intruders/st/HS_SL_LIT.png}
    \caption{HS\_SL\_LIT animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_intruders/st/VB_SL_BIG.png}
    \caption{VB\_SL\_BIG animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_intruders/st/HS_SL_BIG.png}
    \caption{HS\_SL\_BIG animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_intruders/st/VB_FA_LIT.png}
    \caption{VB\_FA\_LIT animation}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_intruders/st/HS_FA_BIG.png}
    \caption{HS\_FA\_BIG animation} 
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/Verification_intruders/st/HS_FA_LIT.png}
    \caption{HS\_FA\_LIT animation}
\end{figure}
...
The following appendix collects the remaining animations omitted from the corresponding chapter due to space constraints. 
It includes the results for the first ten seconds, followed by those pertaining to the first five seconds.

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/VB_SL_LIT.png}
    \caption{VB\_SL\_LIT animation - ten}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/HS_SL_LIT.png}
    \caption{HS\_SL\_LIT animation - ten}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/VB_SL_BIG.png}
    \caption{VB\_SL\_BIG animation - ten}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/HS_SL_BIG.png}
    \caption{HS\_SL\_BIG animation - ten}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/VB_FA_LIT.png}
    \caption{VB\_FA\_LIT animation - ten}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/HS_FA_BIG.png}
    \caption{HS\_FA\_BIG animation - ten} 
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/HS_FA_LIT.png}
    \caption{HS\_FA\_LIT animation - ten}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/five/VB_SL_LIT.png}
    \caption{VB\_SL\_LIT animation - five}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/five/HS_SL_LIT.png}
    \caption{HS\_SL\_LIT animation - five}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/five/VB_SL_BIG.png}
    \caption{VB\_SL\_BIG animation - five}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/five/HS_SL_BIG.png}
    \caption{HS\_SL\_BIG animation - five}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/five/VB_FA_LIT.png}
    \caption{VB\_FA\_LIT animation - five}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/five/HS_FA_BIG.png}
    \caption{HS\_FA\_BIG animation - five} 
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Classic_procedure/five_ten/st/five/HS_FA_LIT.png}
    \caption{HS\_FA\_LIT animation - five}
\end{figure}
