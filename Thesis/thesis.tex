...
The number of selected features and the features itself are collected in the appendix 
...
It also provides a complete list of these features along with their corresponding f-scores, which quantify the relative importance of each feature throughout the evaluation process.
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Feature importance (f-score) for Naive Bayes (80/20 split), sorted from highest to lowest.}
