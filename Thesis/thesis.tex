...
\subsection{Verification single animation - Single Train(ST)}
\label{subsec:vs_st}
...
Figure \ref{fig:VB_FA_BIG_st} illustrates that the best-performing animation, in terms of accuracy, is VB\_FA\_BIG, achieving an accuracy of 92.2\% with the Random Forest classifier and an EER of 3.6\%.
...
Figure \ref{fig:roc_st} presents the ROC curves for each individual animation, obtained using the best-performing classifier based on the Equal Error Rate.
...
\subsection{Verification single animation classic - single train(ST)}
...
\subsection{Verification single animation - Full Train(FT)}
\label{subsec:vft}
...
Figure \ref{fig:VB_FA_LIT_ft} illustrates that the best-performing animation, in terms of accuracy, is VB\_FA\_SMA, achieving an accuracy of 92.6\% with the SVC classifier and an EER of 4\%.
...
Figure \ref{fig:roc_ft} shows the ROC curves for each animation, generated using the classifier that achieved the lowest Equal Error Rate. 
...
\subsection{Verification single animation classic - Full Train(FT)}
...
\section{Static vs Dinamic text}
\label{subsec:s_vs_d}
