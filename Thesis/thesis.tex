...
The figure \ref{fig:id_nofs} illustrates that, for the random split type, the best performance is achieved by the Random Forest classifier, yielding an accuracy of 77.62\%.
...
The figure \ref{fig:id_fs} presents the results obtained from this analysis.
...
The figure \ref{fig:id_s_st} presents a comprehensive collection of the results obtained during the analysis. 
...
The figure \ref{fig:id_s_ft} contains the results obtained evaluating the different models during the analysis.
...
The figure \ref{fig:VB_FA_BIG_st} illustrates that the best-performing animation, in terms of accuracy, is VB\_FA\_BIG, achieving an accuracy of 92.2\% with the Random Forest classifier and an EER of 3.6\%.

\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.8
    \textwidth]{Images/Results/Verification_single/st/VB_FA_LIT.png}
...
This animation is followed by VB\_FA\_SMA, which, as shown in Figure \ref{fig:VB_FA_LIT_st}, achieves an accuracy of 90.9\% using the SVC classifier and an EER of 4.7\%.
...
\begin{figure}[ht]
    ...
    \caption{Classic’ verification results using the ST configuration and VB\_SL\_BIG animation.}
    \label{fig:VB_FA_BIG_cst}
\end{figure}

The table \ref{fig:VB_FA_BIG_cst} display the best performing animation, while the additional results regarding the other animations are contained in Appendix \ref{subsec:vsc_st_ft}.
...
As we observe from figure \ref{fig:VB_FA_BIG_cist} we have a decrease in accuracy from 92.4\% to 91.2\% using nuSVC classifier and an increase of the EER from 4.6\% to 6.2\%.
...
The best-performing animation resulst are collected in Figures \ref{fig:VB_FA_BIG_cst_10} and \ref{fig:VB_FA_BIG_cst_5}.
...
The figure \ref{fig:VB_FA_LIT_ft} illustrates that the best-performing animation, in terms of accuracy, is VB\_FA\_SMA, achieving an accuracy of 92.6\% with the SVC classifier and an EER of 4\%.
...
As illustrated in Figure \ref{fig:VB_FA_BIG_ft}, it attains an accuracy of 90.2\% with the SVC classifier and an EER of 7.3\%. 
...
The figure \ref{fig:VB_FA_LIT_fti} shows that the VB\_FA\_SMA animation yields the highest accuracy among all tested cases, reaching 90.2\% when using the SVC classifier. 
...
As shown in Figure \ref{fig:VB_FA_BIG_fti}, this configuration achieves an accuracy of 87.9\% when using the SVC classifier, along with an EER of 10.1\%. 
...
The table \ref{fig:VB_FA_LIT_cft} presents the best-performing animation, while the additional results for the remaining animations are provided in Appendix \ref{subsec:vsc_ft}.
The current analysis also includes the ROC curves of the best-performing animations, selected according to their Equal Error Rate, as shown in Figure \ref{fig:roc_cft}.
...
The figure \ref{fig:id_stat_dyn} shows the results obtained during the identification analysis. 
...
The figure \ref{fig:pg_nofs} displays the full parameter grid used whenever hyperparameter tuning was performed without applying a feature selection step.
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,HS_SL_BIG,VB_SL_BIG,HS_FA_LIT,HS_FA_BIG}{%
    ...
    \begin{minipage}{0.65\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Results/Verification_single/st/\anim.png}\\[1mm]
        {\small Verification results for single animations using the ST configuration and \expandafter\detokenize\expandafter{\animCaption} animation.}
    \end{minipage}%
    \hfill\par\vspace{0.4cm} % spacing between images
}
\FloatBarrier
...
\foreach \anim in {HS_SL_LIT,HS_SL_BIG,VB_SL_BIG,HS_FA_LIT,HS_FA_BIG}{%
    ...
    \begin{minipage}{0.65\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/Results/Verification_single_intruders/st/\anim.png}\\[2mm]
        {\small Verification with intruders using the ST configuration and \expandafter\detokenize\expandafter{\animCaption} animation.}
    \end{minipage}%
    \hfill\par\vspace{0.4cm} % space between images, allows flexible page breaks
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_LIT,HS_FA_BIG,HS_FA_LIT}{%
    % Replace _LIT with _SMA for cleaner caption
    \StrSubstitute{\anim}{_LIT}{_SMA}[\animCaption]%
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{Images/Results/Verification_single_five_ten/st/ten/\anim.png}\\[2mm]
        {\small Verification results with 10-second recordings using the ST configuration and \expandafter\detokenize\expandafter{\animCaption} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_LIT,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small Verification results with 5-second recordings using the ST configuration and \expandafter\detokenize\expandafter{\animCaption} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_LIT,HS_FA_BIG,HS_FA_LIT}{%
    % Create the caption with _LIT replaced by _SMA
    \StrSubstitute{\anim}{_LIT}{_SMA}[\animCaptionTemp]%
    % Each image as a separate flexible figure
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{Images/Results/Classic_procedure/Verification_single/st/\anim.png}\\[2mm]
        {\small ‘Classic’ verification results using the ST configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_LIT,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small ‘Classic’ verification with intruders using the ST configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
\FloatBarrier
...
% --- Ten seconds ---
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_LIT,HS_FA_BIG,HS_FA_LIT}{%
    % Replace _LIT with _SMA for caption
    \StrSubstitute{\anim}{_LIT}{_SMA}[\animCaptionTemp]%
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{Images/Results/Classic_procedure/five_ten/st/ten/\anim.png}\\[2mm]
        {\small Verification 'classic' results with 10-second recordings using the ST configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_LIT,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small Verification 'classic' results with 5-second recordings using the ST configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,HS_SL_BIG,VB_SL_BIG,HS_FA_LIT,HS_FA_BIG}{%
    ...
    \begin{figure}[H]
        ...
        {\small Verification results using the Full Train (FT) configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,HS_SL_BIG,VB_SL_BIG,HS_FA_LIT,HS_FA_BIG}{%
    % Replace _LIT with _SMA for readable caption
    \StrSubstitute{\anim}{_LIT}{_SMA}[\animCaptionTemp]%
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{Images/Results/Verification_single_intruders/ft/\anim.png}\\[2mm]
        {\small Verification results with intruders using the Full Train (FT) configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_BIG,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small Verification results with 10-second recordings using the FT configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_BIG,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small Verification results with 5-second recordings using the FT configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_BIG,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small ‘Classic’ verification results using the FT configuration and \expandafter\detokenize\expandafter{\animCaption} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_BIG,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small ‘Classic’ verification with intruders using the FT configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
\FloatBarrier
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_BIG,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small Verification 'classic' results with 10-second recordings using the FT configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
...
\foreach \anim in {VB_SL_LIT,HS_SL_LIT,VB_SL_BIG,HS_SL_BIG,VB_FA_BIG,HS_FA_BIG,HS_FA_LIT}{%
    ...
    \begin{figure}[H]
        ...
        {\small Verification 'classic' results with 5-second recordings using the FT configuration and \expandafter\detokenize\expandafter{\animCaptionTemp} animation.}
    \end{figure}
}
