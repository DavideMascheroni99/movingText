...
Finally, the third stage involves hyperparameter optimization, using the parameter grids reported in Appendix 1. 
...
\begin{table}[H]
\centering
\caption{Parameter grids for each classifier (including scaler parameters). 
All pipelines include a \texttt{SimpleImputer} (mean strategy) and one of three scalers: 
\texttt{MinMaxScaler}, \texttt{StandardScaler}, or \texttt{RobustScaler}.}
...
\makecell[l]{– No additional hyperparameters tuned \\ 
\texttt{scaler}: \\ ['MinMaxScaler', 'StandardScaler', 'RobustScaler']} \\
\midrule

\multirow{4}{*}{\makecell[l]{\textbf{K-Nearest Neighbors} \\ (k-NN)}} &
\makecell[l]{\texttt{n\_neighbors}: \\ [3, 5, 7, 9, 11]} \\
& \makecell[l]{\texttt{weights}: \\ ['uniform', 'distance']} \\
& \makecell[l]{\texttt{metric}: \\ ['minkowski', 'euclidean', 'manhattan']} \\
& \makecell[l]{\texttt{scaler}: \\ ['MinMaxScaler', 'StandardScaler', 'RobustScaler']} \\
\midrule

\multirow{2}{*}{\makecell[l]{\textbf{Logistic Regression}}} &
\makecell[l]{\texttt{C}: \\ [0.001, 0.01, 0.1, 1, 10, 100]} \\
& \makecell[l]{\texttt{scaler}: \\ ['MinMaxScaler', 'StandardScaler', 'RobustScaler']} \\
\midrule

\multirow{4}{*}{\makecell[l]{\textbf{Support Vector Machine} \\ (SVC)}} &
\makecell[l]{\texttt{C}: \\ [0.001, 0.01, 0.1, 1, 10, 100]} \\
& \makecell[l]{\texttt{gamma}: \\ [0.001, 0.01, 0.1, 1, 10, 100]} \\
& \makecell[l]{\texttt{kernel}: \\ ['rbf', 'poly']} \\
& \makecell[l]{\texttt{scaler}: \\ ['MinMaxScaler', 'StandardScaler', 'RobustScaler']} \\
\midrule

\multirow{4}{*}{\makecell[l]{\textbf{Nu-Support Vector Machine} \\ (NuSVC)}} &
\makecell[l]{\texttt{nu}: \\ [0.25, 0.5, 0.75]} \\
& \makecell[l]{\texttt{kernel}: \\ ['rbf', 'poly', 'sigmoid']} \\
& \makecell[l]{\texttt{gamma}: \\ ['scale', 'auto']} \\
& \makecell[l]{\texttt{scaler}: \\ ['MinMaxScaler', 'StandardScaler', 'RobustScaler']} \\
\midrule

\multirow{4}{*}{\makecell[l]{\textbf{Random Forest}}} &
\makecell[l]{\texttt{n\_estimators}: \\ [20, 30, 50, 100, 200]} \\
& \makecell[l]{\texttt{max\_features}: \\ ['sqrt']} \\
& \makecell[l]{\texttt{max\_depth}: \\ [5, 10, 20, 30]} \\
& \makecell[l]{\texttt{scaler}: \\ ['MinMaxScaler', 'StandardScaler', 'RobustScaler']} \\
\midrule

\multirow{6}{*}{\makecell[l]{\textbf{Multilayer Perceptron} \\ (MLP)}} &
\makecell[l]{\texttt{hidden\_layer\_sizes}: \\ [(100,), (100, 50), (150, 100, 50)]} \\
& \makecell[l]{\texttt{activation}: \\ ['tanh', 'relu']} \\
& \makecell[l]{\texttt{alpha}: \\ [0.0001, 0.001, 0.01]} \\
& \makecell[l]{\texttt{learning\_rate\_init}: \\ [0.001, 0.01]} \\
& \makecell[l]{\texttt{solver}: \\ ['adam']} \\
& \makecell[l]{\texttt{scaler}: \\ ['MinMaxScaler', 'StandardScaler', 'RobustScaler']} \\
\bottomrule
\end{tabular}
\end{table}
