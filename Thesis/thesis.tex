...
\begin{titlepage}
    ...
    \includegraphics[width=6cm]{Images/Theory/logo.png} 
...
The GP3\_HD provides normalized screen coordinates of each fixation (FPOGX, FPOGY), which indicate the point of regard on the display. 
...
Beyond two-dimensional gaze data, the GP3\_HD also captures three-dimensional eye position features, reporting the x-, y-, and z-coordinates of each eye relative to the eye tracker (LEYEX, LEYEY, LEYEZ for the left eye; REYEX, REYEY, REYEZ for the right eye). 
...
For each blink, the GP3\_HD assigns a unique identifier (BKID), records its duration (BKDUR), and stores the minimum pupil size observed during the event (BKPMIN), which reflects the degree of occlusion. 
...
Taken together, the features recorded by the GP3\_HD provide a comprehensive view of ocular activity. 
...
In the present analysis, blink-related features were derived from the identifiers and durations recorded by the GP\_HD 3 eye tracker.
